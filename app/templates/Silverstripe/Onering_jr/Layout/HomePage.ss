<!--Originally from the home.html file as content between header and footer. Connects to layout variable in templates whilst autooload and database update has created namesspace link to connect HomePage class to Page class-->
			...
			<div class="container">
				<div class="row">
					...
					<div class="main col-sm-8">
						...
						<!--Call the homepage controller class funciton LaysestArticles-->
